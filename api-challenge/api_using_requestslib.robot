...
Validate A Room Reservation Through The API
    ...
    Should Be Equal  ${reservation}[accesible]  ${room_to_verify}[accesible]
    ...  Room accesibility added [${reservation}[accesible]] does not match room accesibility on record [${room_to_verify}[accesible]]
